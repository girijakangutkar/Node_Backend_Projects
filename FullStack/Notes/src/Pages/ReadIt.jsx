    ...
    <div className="fixed inset-0 bg-gray-50 z-50 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4 overflow-hidden">
        ...
        >
          ...
          {/* Page content */}
          <div className="h-full ml-8 mr-4 py-12 px-5 overflow-y-auto text-justify hide-scrollbar">
            <div className="prose prose-gray max-w-none min-h-full">
              <div className="text-gray-900 leading-relaxed text-lg whitespace-pre-wrap">
